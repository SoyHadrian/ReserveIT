        ...
        <form class="form" action="" method="post">
            ...
            <div class="form_container">
                <div class="form_group">
                    ...
                    <label for="pass" class="form_label">Nombre de usuario</label>
                ...
                <div class="form_group">
                    <input type="password" id="pass" class="form_input" placeholder=" " name="pass">
                    <label for="pass" class="form_label">Repetir contraseña</label>
                    <span class="form_line"></span>
                </div>
                <input type="submit" class="form_submit" value="Registrar" name="btnregistrar">
            </div>
        </form>
    </div>
